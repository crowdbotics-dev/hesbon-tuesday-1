"""
Django settings for hesbon_tuesday_1 project.
...
ROOT_URLCONF = 'hesbon_tuesday_1.urls'
...
WSGI_APPLICATION = 'hesbon_tuesday_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hesbon_tuesday_1 API",
    "DESCRIPTION": "API documentation for hesbon_tuesday_1 App",
    "VERSION": "v1",
}
